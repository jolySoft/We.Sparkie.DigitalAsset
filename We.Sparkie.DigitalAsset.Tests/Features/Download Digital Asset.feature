...
Scenario: List out assets
    Given I have uploaded these assets
        ...
        | F9700558-A488-40BD-B572-E301C4D5286D | Brian Adams - Some really bad.wav              | 4AFE0223-6007-4C0D-898D-6BB0B89328F6 | 7,0345,462 | 16        | 44100       |
    ...
    Then I get this list
        ...
        | F9700558-A488-40BD-B572-E301C4D5286D | Brian Adams - Some really bad.wav              | 7,0345,462 | 16        | 44100       |
